...
class MainController extends Controller
{
    ...
    public function designs(): View
    {
        ...
        return view('index', ["show" => false, "error" => false, "length" => $this->length, "title" => $this->companyTitle, "x" => $this->xUrl, "facebook" => $this->facebookUrl, "instagram" => $this->instagramUrl, "phone" => $this->companyPhone, "email" => $this->companyEamil,]);
    }
    ...
    public function errorPage(): View
    {
        !session()->has('lang') ? session()->put('lang', $this->lang[0]) : null;
        App::setLocale(session('lang'));
        return view('index', ["show" => false, "error" => true, "length" => $this->length, "title" => $this->companyTitle, "x" => $this->xUrl, "facebook" => $this->facebookUrl, "instagram" => $this->instagramUrl, "phone"=>$this->companyPhone, "email" => $this->companyEamil,]);
    }
}
