        ...
        <!-- Footer -->
            <footer id="footer">
                ...
                <ul class="icons">
                    ...
                    <!-- Address -->
                    <li>
                        <a class="copy-event" onclick="setCopProperty(2, '{{explode(': ', __('context.address_info'))[1]}}')" data-tooltip="{{explode(': ', __('context.address_info'))[1]}}">
